...
| `aldi_2026_09.py` | the September re-collection: which field actually sets price (zone/shop/county/state), Sep vs Aug on paired ZIPs, the carve-out across 26 basket items, then the Walmart-vs-Aldi racial comparison on fresh data |
