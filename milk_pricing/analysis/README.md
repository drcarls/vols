...
| `income_race_joint.py` | `reports/income_race_joint.md` — race and income entered together on the 1,003 rural ZIPs carrying both retailers: race is ~0 at both chains once income is in, income is −7.5c/gal per $10k at Walmart (t −4.44) with state FE |
