...
Cost at our volume is negligible: one request per company, ~$1.50/1000
requests PAYG with a 5k/month free tier. Failed requests aren't billed.
"""
...
class BrightDataSerpBackend:
    ...
    def _google_url(self, query: str, country: str, language: str) -> str:
        params = {
            "q": query,
            "gl": country,      # geo-target (se)
            "hl": language,     # interface language (sv)
            "num": "20",
